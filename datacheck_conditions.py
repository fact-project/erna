...
conditions["dorner"] = [
    ...
    "NOT fNight BETWEEN 20121206 AND 20130110",  # broken bias channel
...
"fNight BETWEEN 20140630 AND 20150630", # used time range for the set
"fTriggerRateMedian < 85",
"fTriggerRateMedian > 40",
"fMoonZenithDistance > 100",
"fThresholdMinSet < 350",
...
"fZenithDistanceMax < 30", # zenith cut
"fZenithDistanceMin > 6", # zenith cut
"fNight BETWEEN 20130630 AND 20140205", # used time range for the set
"fTriggerRateMedian < 85",
"fTriggerRateMedian > 40",
"fMoonZenithDistance > 100",
"fThresholdMinSet < 350",
